...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    price: 109,
    description:
      '3D NAND flash are applied to deliver high transfer speeds. A sleek and thin design for an easy upgrade in ultrabooks and slim notebooks.',
    category: 'electronics',
  ...
  },
  {
    ...
    price: 29.95,
    description:
      '100% POLYURETHANE (shell) 100% POLYESTER (lining) 75% POLYESTER 25% COTTON (sweater), Faux leather material for style and durability.',
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 39.99,
    description:
      'Lightweight perfect for trip or casual wear. Long sleeve with hooded, adjustable drawstring waist design. Button and zipper front closure.',
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 7.95,
    description:
      '100% Polyester, Machine wash, 100% cationic polyester interlock, Lightweight, roomy and highly breathable with moisture wicking fabric.',
    category: "women's clothing",
